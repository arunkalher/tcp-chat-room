import threading
import socket
clients=[] # tuple with first element as a soc obj and second element is client name ( provided by client )
nick_names=[]
Socket=socket.socket()
Socket.bind(('localhost',12345)) # bind socket to ip add- localhost and arbitrary available port no
